...
//       console.log(recipe)
//       return recipeListItemHtml(recipe.title, "vegan", recipe.readyInMinutes, recipe.servings, recipe.image)
//     })
//     console.log(itemsHtml)
//   }

//   function recipeListItemHtml(name, diet, duration, servings, imageUrl) {
//     return (
//       `<tr>
//         <td>${name}</td>
//         <td>${diet}</td>
...
// // use this concept to display recipes in grid
